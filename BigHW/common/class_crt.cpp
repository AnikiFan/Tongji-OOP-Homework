...
{
	return get_all_item(group_name, ret, ignore_lower_upper_case);
}
...
{
	return get_one_item(group_name, item_name, ret, ignore_lower_upper_case);
}
...
{
	return	item_get_value(group_name, item_name, def_str, value, ignore_lower_upper_case);
}
/***************************************************************************
  函数名称：
  功    能：
