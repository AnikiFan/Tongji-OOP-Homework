...
int main()
{
	...
	if (1) {//append函数测试
		...
		cout << "append()简单测试(TStringAdv类和TStringAdv类、字符指针、字符数组、字符)" << endl;
	...
	if (1) {//insert函数测试
		...
		cout << "insert()简单测试(TStringAdv类和TStringAdv类、字符指针、字符数组、字符)" << endl;
	...
	if (1) {//erase函数简单测试
		...
		cout << "erase()简单测试(TStringAdv类和TStringAdv类、字符指针、字符数组、字符)" << endl;
	...
	if (1) {//erase函数综合测试
		...
		cout << "erase()综合测试(TStringAdv类和TStringAdv类、字符指针、字符数组、字符)" << endl;
	...
	if (1) {//substr函数测试
		const TStringAdv s1 = "testsubstr";
		TStringAdv s2;

		cout << "substr()测试" << endl;

		s2 = s1.substr(0, 3);
		cout << "s2应为<NULL>，    实际输出：" << s2 << endl;

		s2 = s1.substr(s1.length() + 1, 3);
		cout << "s2应为<NULL>，    实际输出：" << s2 << endl;

		s2 = s1.substr(1, 4);
		cout << "s2应为test，      实际输出：" << s2 << endl;

		s2 = s1.substr(5, 100);
		cout << "s2应为substr，    实际输出：" << s2 << endl;

		s2 = s1.substr(1, 0);
		cout << "s2应为testsubstr，实际输出：" << s2 << endl;
